...
-- populate mobile country codes table (mccs)
-- NOTE: create_routine_tables.sql must have been ran before this script (it creates the mccs table)
-- usage:
-- psql -U routine -d routine_db -f populate_mccs_table.sql

COPY mccs (mcc, abbr, name) FROM stdin;
302	CA 	Canada
